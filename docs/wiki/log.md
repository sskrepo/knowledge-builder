...
## [2026-05-06] pm (acting via tpm) | Authored docs/wiki/persona-onboarding-pm-tpm.md — workbook for PM and TPM team leads to refine 'what to extract' from raw sources
